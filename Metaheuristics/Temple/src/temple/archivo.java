   ...
   public void leerArchivo1() {
      ...
      try {
       ...
       {//Variables columnas
        ...
        temple.matriz[i][j]= Integer.parseInt(separacion[i]);
        //System.out.println(temple.matriz[i][j]);
        temple.matriz[j][i]= temple.matriz[i][j];   
      ...
      try {
       ...
       {//Variables columnas
        ...
        temple.lectura[i]= Float.parseFloat(linea);
